...
DEFAULT_OLLAMA_SUMMARY_TIMEOUT = float(
    os.environ.get("KURRENT_SUMMARY_LLM_TIMEOUT", "180")
)
DEFAULT_OLLAMA_SUMMARY_MAX_NUM_CTX = int(
    os.environ.get("KURRENT_SUMMARY_LLM_NUM_CTX", "16384")
)
DEFAULT_SUMMARY_DEPTH = int(
    os.environ.get("KURRENT_SUMMARY_DEPTH", "2")
)
